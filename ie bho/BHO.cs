...
namespace IEMonitor
{
    ...
    public interface IExtension
    {
        ...
        void sendPatientInfo(string patient);
    }
    ...
    public class BHO : IObjectWithSite, IExtension
    {
        ...
        public void sendPatientInfo(string msg)
        {
            //string aa = "{\"hello\":\"C#  mircosoft.....\"}";
            string aa = "{\"data\":\"" + msg + "\"";
            //WebRequest request = WebRequest.Create("http://weixin.3dy.me:8809/v13/opendata/test/");
