...
namespace IEMonitor
{
    ...
    public class BHO : IObjectWithSite, IExtension
    {
        ...
        public void WriteLog2222(string documentName, string msg)
        {
           //string errorLogFilePath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Log");
            // TODO - path to app dir
            //string errorLogFilePath = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "/bholog/";
            
            //msg="{\"hello\":\"C#  mircosoft.....\"}";
            /*
            string aa="{\"hello\":\"C#  mircosoft.....\"}";
             WebRequest request = WebRequest.Create("121.204.198.52:8809/v13/opendata/test/");
            request.Method = "POST";
